...
def generate_statistics(
    ...
    def write_setup_py_file():
        ...
        # Create the xxx.py file for managing pipeline dependencies
        logging.info("Writing xxx.py to disk")
    ...
    if use_dataflow:
        ...
        # If not using a prebaked container image, use xxx.py for TFDV installation
        else:
            logging.info(f"Using xxx.py file. TFDV version is {tfdv.__version__}")
            write_setup_py_file()
            setup_options.setup_file = "./xxx.py"
