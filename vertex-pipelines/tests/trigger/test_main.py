...
def test_cf_handler():
    ...
    with mock.patch(
        "vertex-pipelines.trigger.main.trigger_pipeline_from_payload"
...
def test_trigger_pipeline():
    ...
    with mock.patch("vertex-pipelines.trigger.main.aiplatform") as mock_aiplatform:
...
def test_sandbox_run():
    ...
    with mock.patch(
        "vertex-pipelines.trigger.main.get_args"
